        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="search_docs.php">Search Doctors</a>
              </li>
              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="detail-box">
                    ...
                    <p>
                        At Care App, we are dedicated to providing the best healthcare services to our patients. Our team of highly skilled doctors, nurses, and staff work tirelessly to ensure that every individual receives personalized care and attention.
                    </p>
                    <div class="btn-box">
                      <a href="patient_signup.php" class="btn1">
                        User Sign Up 
                      </a>
                    </div>
                  </div>
    ...
    <div class="container">
      ...
      <div class="footer-info">
        <p>
          ...
          <a href="#">Care App<br><br></a>
            &copy; <span id="displayYear"></span> Made By
            <a href="#">Yashal Nawaid 20k-1662</a>
        </p>
